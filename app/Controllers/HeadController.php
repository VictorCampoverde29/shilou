...
class HeadController extends Controller
{
    ...
    public function update()
    {
        ...
        try {
            ...
            return $this->response->setJSON(['success' => true, 'message' => 'Head actualizado exitosamente.']);
        } catch (\Exception $e) {
            return $this->response->setJSON(['error' => 'Ocurrió un error al actualizar el head: ' . $e->getMessage()]);
        }
    }
    public function updateDetalle()
    {
        ...
        try {
            ...
            return $this->response->setJSON(['success' => true, 'message' => 'Detalle de head actualizado exitosamente.']);
        } catch (\Exception $e) {
            return $this->response->setJSON(['error' => 'Ocurrió un error al actualizar el detalle de head: ' . $e->getMessage()]);
        }
    }
}